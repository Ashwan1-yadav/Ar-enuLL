...
export const ProfessionalConnect = () => {
  ...
  const socialPlatforms = [
    ...
    },
    {
      ...
      link: "https://www.instagram.com/navriox_digital_solutions/",
    ...
    },
    {
      ...
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="w-7 h-7">
          <path d="M22.675 0h-21.35C.597 0 0 .597 0 1.326v21.348C0 23.403.597 24 1.326 24h11.495v-9.294H9.692V11.01h3.129V8.309c0-3.1 1.893-4.788 4.659-4.788 1.325 0 2.464.099 2.795.143v3.24h-1.918c-1.504 0-1.796.715-1.796 1.763v2.313h3.587l-.467 3.696h-3.12V24h6.116C23.403 24 24 23.403 24 22.674V1.326C24 .597 23.403 0 22.675 0z" />
        </svg>
      ),
      gradient: "from-blue-600 to-blue-400",
      shadowColor: "rgba(37, 99, 235, 0.5)",
      link: "https://www.facebook.com/profile.php?id=61586290151436",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black-950 via-slate-900 to-black-950 overflow-hidden relative w-full">
      {/* Animated Background */}
      <div className="absolute inset-0">
        ...
        {/* Animated Grid */}
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#000000_1px,transparent_1px),linear-gradient(to_bottom,#000000_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]"></div>
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-2xl p-8 border border-slate-700/50 overflow-hidden transition-all duration-500 hover:scale-105 hover:border-slate-600/50">
                ...
                <div className="relative z-10">
                  {/* Icon Container */}
                  <div
                    className={`mb-4 inline-flex p-3 rounded-xl bg-gradient-to-br ${platform.gradient} text-white transform transition-transform duration-500 group-hover:rotate-6 group-hover:scale-110`}
                  >
                    {platform.icon}
                  </div>
